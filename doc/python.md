...
### 进程和线程的关系
1. 线程只能属于一个进程，进程可以有多个线程，但至少有一个线程
2. 资源分配给进程，同一进程的所有线程共享该进程的所有资源
3. 线程是进程的实际运行单位

### 进程和线程的区别
1. 基本单位：进程是资源分配的最小单位，线程是资源调度的最小单位
2. 并发行：进程和线程都可并发
3. 资源：进程是拥有资源的一个独立单位，线程不拥有系统资源，只拥有运行时不可少的资源
...
| 可靠性           | 进程之间互不影响           | 一个线程会导致整个进程挂掉 | 进程占优 |      |
| 分布式           | 适用于多核、多机，扩展简单 | 适用于多核                 | 进程占优 |      |
